...
import com.dd.service.config.builder.ConfigServerECSService
import javaposse.jobdsl.dsl.JobParent

def factory = this as JobParent
def listOfEnvironment = ["dev", "qa", "prod"]
def component = "config-server-ecs-service-job"

def emailId = "vivekmishra22117@gmail.com"
def description = "Pipeline DSL to create ECS Service for Config-Server"
def displayName = "Config-Server ECS Service Job"
def branchesName = "*/master"
def githubUrl = "https://github.com/vivek22117/config-server-app.git"


new ConfigServerECSService(
        dslFactory: factory,
